...
export const generateSalesReport = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    Notification.create({
      ...
      body: `sales report generated by ${req.user?.role}`,
      severity: "info",
      timestamp: new Date(),
    }).catch((err) => console.error("Notification error (sales report):", err));
...
export const generateCashReconciliationReport = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    Notification.create({
      ...
      category: "report_generated",
      title: "Report Generated",
      body: `cash_reconciliation report generated by ${req.user?.role}`,
      severity: "info",
      timestamp: new Date(),
    }).catch((err) => console.error("Notification error (cash reconciliation report):", err));
...
export const generateShiftReport = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    Notification.create({
      ...
      category: "report_generated",
      title: "Report Generated",
      body: `shift report generated by ${req.user?.role}`,
      severity: "info",
      timestamp: new Date(),
    }).catch((err) => console.error("Notification error (shift report):", err));
...
export const generateFuelInventoryReport = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    Notification.create({
      ...
      category: "report_generated",
      title: "Report Generated",
      body: `fuel_inventory report generated by ${req.user?.role}`,
      severity: "info",
      timestamp: new Date(),
    }).catch((err) => console.error("Notification error (fuel inventory report):", err));
...
export const generateStaffPerformanceReport = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    Notification.create({
      ...
      category: "report_generated",
      title: "Report Generated",
      body: `staff_performance report generated by ${req.user?.role}`,
      severity: "info",
      timestamp: new Date(),
    }).catch((err) => console.error("Notification error (staff performance report):", err));
...
export const generateLubricantInventoryReport = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    Notification.create({
      ...
      category: "report_generated",
      title: "Report Generated",
      body: `lubricant_inventory report generated by ${req.user?.role}`,
      severity: "info",
      timestamp: new Date(),
    }).catch((err) => console.error("Notification error (lubricant inventory report):", err));
