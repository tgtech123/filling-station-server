...
import announcements from "./routes/systemAnnouncement.route";
import receiptSettings from "./routes/receiptSettings.route";
import shiftTender from "./routes/shiftTender.route";
...
app.use("/api/receipt-settings", receiptSettings);
app.use("/api/shift-tender", shiftTender);
